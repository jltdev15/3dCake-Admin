...
const confirmAcceptOrder = () => {
  ...
  confirmationTitle.value = 'Accept Custom Order'
  confirmationMessage.value = 'Are you sure you want to accept this custom order?'
...
const confirmDeclineOrder = () => {
  ...
  confirmationTitle.value = 'Decline Custom Order'
  confirmationMessage.value = 'Are you sure you want to decline this custom order?'
